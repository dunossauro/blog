...
Mas, como diria Ferreira Gullar: ["a vida bate"](https://contobrasileiro.com.br/a-vida-bate-poema-de-ferreira-gullar/). Porque esse "e agora" nunca é sobre o que vem depois do básico, o "a seguir", o que se prossegue. Lembre-se, a premissa é "aprendi", parte do pressuposto de que a pessoa, no caso você, já sabe o suficiente.
...
- Ramificações (branches) com significados sendo mantidas simultaneamente, como no [Git flow](https://www.atlassian.com/br/git/tutorials/comparing-workflows/gitflow-workflow)
...
Em conjunto com isso, parte sendo validada no seu ambiente pessoal por hooks de pré-commit, com suas ferramentas específicas, e sendo validado na estrutura completa em um ambiente de [integração contínua](https://pt.wikipedia.org/wiki/Integra%C3%A7%C3%A3o_cont%C3%ADnua) que usam linguagens de configurações diferentes a depender da plataforma.

Que, no final, o produto disso será uma release versionada, um artefato do sistema, que precisa dos seus registros de alteração ([changelogs](https://keepachangelog.com/pt-BR/1.1.0/)) e deve seguir um padrão de versionamento como [SemVer](https://semver.org/lang/pt-BR/) ou [CalVer](https://calver.org/overview_pt_br.html).
