+++
title = "Aprendi a programar e agora? Uma breve descrição sobre o ciclo de desenvolvimento."
tags = ["tech"]
date = 2026-05-24T21:39:21-03:00
[comments]
host = "bolha.us"
username = "dunossauro"
...
Nesses últimos tempos, tenho pensado bastante sobre as "capacidades" que considero importantes em uma pessoa que desenvolve software. Sem nenhuma razão específica, acredito eu. Na verdade, essa pulga apareceu na minha cabeça após ter lido o texto incrível da [Iris Meredith](https://mastodon.social/@iris_meredith) intitulado ["Becoming an AI-proof software engineer"](https://deadsimpletech.com/blog/ai-proof-engineer), ou, em bom português, "Tornando-se um engenheiro de software à prova de IA". Embora o foco principal da postagem seja falar sobre a insanidade do mercado a respeito de [papagaios estocásticos](https://pt.wikipedia.org/wiki/Papagaio_estoc%C3%A1stico), meus pensamentos convergem com o texto da Iris, mas não são relacionados com LLMs. Eles permeiam na questão que mais recebi nessa vida ensinando programação: "aprendi a programar e agora?"
...
Mas, como diria Ferreira Gullar: ["a vida bate"](https://contobrasileiro.com.br/a-vida-bate-poema-de-ferreira-gullar/). Porque esse "e agora" nunca é sobre o que vem depois do básico, o "a seguir", o que se prossegue. Lembre-se, a premissa é "aprendi", parte do pressuposto que a pessoa, no caso você, já sabe o suficiente.
...
Porque, claro, disseram que isso dá muito dinheiro! Obviamente, dá, pensando na [realidade do Brasil](https://agenciadenoticias.ibge.gov.br/agencia-noticias/2012-agencia-de-noticias/noticias/46579-rendimento-medio-da-populacao-brasileira-atinge-r-3-367-em-2025). Mas, infelizmente, você vai ter que [cair 7 vezes](https://beneviani.blogspot.com/2013/06/minhas-7-quedas-paulo-leminski.html), como diria Leminski, antes de entender o tamanho do buraco.

Se você veio parar na programação pelo sonho do dinheiro fácil, vamos a um dado real do ensino formal. O que está contido nesse "aprendi programação" é uma matéria de 40 horas de um bacharelado que tem no mínimo 2.400 horas. Dá pra notar que existe um grande "gap" aqui. Mas claro, o ensino formal não é um pré-requisito pro mercado. Mesmo pra quem vem de uma graduação, olhar o que o mercado de trabalho exige pode ser meio assustador.
...
Notou uma coisa em particular? Nenhuma das vagas tem como requisito "programação". Elas pedem coisas bastante objetivas. Tecnologias específicas, conceitos específicos, vivências específicas.
...
Inicialmente parece muita coisa (e é), mas todos esses requisitos juntos explicam muito sobre a cultura atual de "egenheirar" software do que exatamente as capacidades específicas e super técnicas de ferramentas.
...
Onde quero chegar com isso? A primeira habilidade e a mais óbvia que "se espera" de uma pessoa profissional é que ela "saiba trabalhar", que você conheça o seu ferramental de trabalho. Você precisa de autonomia, domínio do seu editor de texto. Não importa se ele for o GNU/Emacs, o Vim, o Helix, o [maligno VSCode](https://ghuntley.com/fracture/), o Kate... Não importa. Ele é seu parceiro de trabalho, sua ferramenta. Você tem que AMASSAR com ele, usar a seu favor.

Você precisa conhecer seu sistema operacional, independente de qual seja, você precisa dominar o seu shell. Fora isso, no escopo da sua linguagem, você precisa dominar o gerenciamento de pacotes, como instalar e desinstalar bibliotecas, como compilar algo, como gerar um pacote, etc. Entender as boas práticas de formatação (code style), como pegar erros antes com seus [linters](https://pt.wikipedia.org/wiki/Linter_(computa%C3%A7%C3%A3o)) e [LSPs](https://langserver.org/). Você **precisa dominar seu ferramental**.

Isso vai além do técnico, da ferramenta em si. Isso é sobre confiança. Saber como usar, entender os resultados que serão gerados, aprender onde erros são apontados, como interpretar essas mensagens, como as ferramentas se comportam em situações diferentes, etc.

É sobre ser proficiente no seu ambiente de trabalho. Pense em um mecânico de carro, no meio de todo aquele mundaréu de ferramentas, ele sabe onde está e o que ela faz, o que ela resolve. Reforçando, não é sobre a tecnologia, é sobre a confiança de conhecê-las. É sobre ser "funcional" fazendo o que você sabe fazer. É sobre autonomia no seu trabalho.
...
Em algum momento, o "git" vai bater na sua porta. Mas "aprendi git" é o "aprendi programação" central nesse texto. É só a ferramenta. Versionamento de software quer basicamente dizer que nenhum software fica pronto nunca. Ele é vivo: vive de atualizações e manutenção constante. E saber lidar com versionamento é entender que sempre vai existir uma "próxima versão". Versões em uma empresa querem dizer muitas coisas escondidas que são muito mais do que Git. É sobre lidar com muitas pessoas "commitando" código no mesmo repositório ao mesmo tempo. Mudanças conflitantes, em linhas do tempo diferentes, adicionando, removendo, alterando... É o caos!

Fora o conhecimento "básico" da ferramenta git, entram requisitos "semânticos" silenciosos como:

- Ramificações com significados sendo mantidas simultaneamente, como no [Git flow](https://www.atlassian.com/br/git/tutorials/comparing-workflows/gitflow-workflow)
- Padronização no nome delas como em [Conventional Branch](https://conventional-branch.github.io/pt-br/)
- Ordenadas por padrões sintáticos em commits como em [Conventional Commits](https://www.conventionalcommits.org/pt-br/v1.0.0/).

Em conjunto com isso, sendo validado no seu ambiente pessoal por hooks de pré-commit, com suas ferramentas específicas, e sendo validado na estrutura completa em um ambiente de [integração contínua](https://pt.wikipedia.org/wiki/Integra%C3%A7%C3%A3o_cont%C3%ADnua) que tem linguagens diferentes a depender da plataforma.

Que, no final, o produto disso será uma release versionada, uma versão do sistema, que precisa dos seus registros de alteração ([changelogs](https://keepachangelog.com/pt-BR/1.1.0/)) e deve seguir um padrão de versionamento como [SemVer](https://semver.org/lang/pt-BR/) ou [CalVer](https://calver.org/overview_pt_br.html).
...
Uma coisa que apareceu nas três vagas, e de passagem o tópico que sou mais apaixonado nesse mundo da programação, são os testes!

Durante toda a formação de uma pessoa que desenvolve software, esse talvez seja o tópico mais subestimado de todos. Porque, afinal, testes são uma coisa meio óbvia. "Você vai escrever um código que seja capaz de validar se o código que está no programa faz o que deveria fazer". Ao mesmo tempo em que isso é óbvio, isso passa de forma silenciosa por nós. Já ouvi papos assustadores como: "quem testa é o cliente", "fui eu que fiz, funciona" ou então o mais assustador de todos: "testes atrasam o desenvolvimento".
...
Vamos imaginar o cenário do tópico anterior: "várias pessoas juntas trabalhando no mesmo repositório". Como conseguimos garantir que qualquer uma das pessoas não alterou o comportamento do sistema a ponto de ele não fazer o que deveria? E... olha só, os testes poderiam garantir isso a cada alteração. É o que chamamos de "[regressão](https://pt.wikipedia.org/wiki/Teste_de_regress%C3%A3o)". Garantir que, nas interações das pessoas com o repositório, o comportamento não "regrida". Basicamente, funciona como foi feito pra funcionar.
...
Vários tópicos são muito importantes nesse assunto. Se o código de produção tem padrões, os [testes também têm](http://xunitpatterns.com/), existem formas de simular comportamentos com [dubles](http://xunitpatterns.com/Test%20Double%20Patterns.html), existem [proporções de granularidade](https://testing.googleblog.com/2010/12/test-sizes.html), têm seus próprios [problemas](https://blog.codepipes.com/testing/software-testing-antipatterns.html), sua própria ordem de [inicialização](http://xunitpatterns.com/Fixture%20Setup%20Patterns.html) e [finalização](http://xunitpatterns.com/Fixture%20Teardown%20Patterns.html), sua [organização](https://freedium-mirror.cfd/https://medium.com/@pjbgf/title-testing-code-ocd-and-the-aaa-pattern-df453975ab80), etc.
...
Sabe o que é engraçado? As vagas pediam CI (Integração contínua) e é nesse ponto em que você entende que o processo realmente converge. Sim, as coisas são coerentes. A técnica de integração contínua quer dizer algo meio óbvio, que escapa às vezes no termo técnico.

Imagina que estamos trabalhando em grupo, porque claro, estamos! Commitando a todo momento, cada um no seu quadrado, cada um nos seus testes. A integração contínua é o momento de *garantir* que o software está em estado constante de mudança. Integrando mais e mais alterações continuamente. Uma ferramenta de CI é responsável por pegar o individual feito e tentar juntar. Ela vai rodar diversas validações pra ver se a alteração A combina com a B. Em questão de [analisadores estáticos](https://pt.wikipedia.org/wiki/Linter_(computa%C3%A7%C3%A3o)), aqueles mesmos que você tem no seu ambiente pessoal, para garantir uma conformidade do time. Um código "unificado" que parece do time, com os padrões do time. Em code style, em qualidade, executando os testes, validando a semântica dos commits e tudo mais.
...
Bom... Depois disso, o ciclo continua, mas tem mais coisas que precisamos falar aqui, coisas que também se escondem nos requisitos. Apareceu só na primeira vaga. Quem é o acompanhamento da aplicação quando ela "vai pro mundo", o depois do deploy.

Existem formas de "saber o que a aplicação está fazendo enquanto está rodando em produção". Chamamos isso de [observabilidade](https://opentelemetry.io/docs/concepts/observability-primer/): a arte de entender a "saúde" da aplicação em tempo real. Via:
...
O acompanhamento da aplicação fornece novos insumos, que geram novas versões, detectam comportamentos estranhos, etc. Coisas que serão priorizadas em um novo ciclo do desenvolvimento do software vivo que temos. Fornecendo possíveis correções, lugares onde precisamos de mais atenção, validações.
...
Qualquer plataforma moderna de repositórios (codeberg, gitlab, github) pode te oferecer o ferramental completo até a integração contínua. De forma gratuita e oferecendo uma boa documentação. Já pra colocar em produção, você pode procurar por clouds que ofereçam planos gratuitos para deploy e monitoramento. Desde uma coisa mais simples como [PaaS](https://www.redhat.com/pt-br/topics/cloud-computing/what-is-paas) para diminuir o atrito, que comumente oferecem até mesmo dashboards prontos para monitorar, até [VPSs](https://en.wikipedia.org/wiki/Virtual_private_server) completas onde o trabalho é mais manual, mas podem te oferecer mais proximidade com a infraestrutura por trás das coisas.
...
Mas quando você vê esse ciclo "rodando". Daquelas linhas do seu editor de texto até a aplicação rodando em produção, pessoas acessando, versões sendo construídas, você entende que "engenheirar" software é muito mais sobre o "adorno" em volta do código, sobre a garupa lateral da moto.
